...
const NAV = [
  { href: "/producer/dashboard", icon: LayoutDashboard, label: "Dashboard" },
  { href: "/producer/products", icon: Package, label: "Products" },
  { href: "/producer/orders", icon: ClipboardList, label: "Orders" },
  { href: "/producer/payouts", icon: Wallet, label: "Payouts" },
];
