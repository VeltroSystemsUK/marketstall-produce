      ...
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-black/5">
          <button
            ...
            disabled={loading}
            className="mb-4 flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white py-2.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 disabled:opacity-60"
          >
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 px-3 py-2.5 pr-10 text-sm focus:border-forest-400 focus:outline-none focus:ring-2 focus:ring-forest-100"
                />
                <button
                  type="button"
